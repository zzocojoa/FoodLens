...
description: FoodLens Terms of Service
...
- Food, label, and barcode analysis
- Warnings based on user allergies and dietary restrictions
- Profile, settings, history, and Food Passport features
- Support inquiries, privacy policy, and terms documents
...
- Analysis results may differ from actual ingredients.
- Errors may occur with complex prepared foods, unclear photos, or missing label information.
...
- Use another person's account or information without permission
- Submit false reports, malicious automated requests, or otherwise abuse the service
