...
run_case() {
  ...
  MIN_RENDER_CACHE_MISS_SAMPLES="${MIN_RENDER_CACHE_MISS_SAMPLES:-15}" \
  RENDER_CACHE_MISS_P95_HARD_THRESHOLD_MS="${RENDER_CACHE_MISS_P95_HARD_THRESHOLD_MS:-3000}" \
  RENDER_CACHE_MISS_P95_WARN_THRESHOLD_MS="${RENDER_CACHE_MISS_P95_WARN_THRESHOLD_MS:-2500}" \
