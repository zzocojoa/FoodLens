...
export const LOGIN_COPY = {
  ...
  providerRateLimited: 'Too many login attempts. Please wait a moment and try again.',
...
export const createLoginCopy = (
  ...
  supportHint: translate('login.support.hint', LOGIN_COPY.supportHint),
  supportHelp: translate('login.support.help', LOGIN_COPY.supportHelp),
  supportContact: translate('login.support.contact', LOGIN_COPY.supportContact),
  ...
  providerRateLimited: translate('login.error.providerRateLimited', LOGIN_COPY.providerRateLimited),
