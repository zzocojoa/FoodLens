    ...
    return (
        <View style={styles.section}>
            ...
            <View style={styles.inputGroup}>
                <Text style={styles.label}>{t('profileHub.identity.displayName', 'DISPLAY NAME')}</Text>
                <View style={styles.inputWrapper}>
                    <TextInput
                        ...
                        placeholder={t('profileHub.identity.namePlaceholder', 'Enter your name')}
                    ...
                    <HapticPressable
                        ...
                        accessibilityLabel={t('profileHub.identity.clearDisplayName', 'Clear display name')}
                    >
            ...
            <View>
                <Text style={[styles.label, { marginBottom: 12 }]}>{t('profileHub.identity.presets', 'PRESETS')}</Text>
                <View style={styles.presetGrid}>
                    ...
                    >
                        <View pointerEvents="none" style={{ alignItems: 'center', gap: 4 }}>
                            ...
                            <Text style={styles.uploadText}>{t('profileHub.identity.upload', 'Upload')}</Text>
                        </View>
                    </HapticTouchableOpacity>
                </View>
            </View>
