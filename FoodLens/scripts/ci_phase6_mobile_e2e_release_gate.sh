...
IOS_REAL_DEVICE_EVIDENCE_URI="$(trim_value "${MOBILE_E2E_IOS_REAL_DEVICE_EVIDENCE_URI:-}")"
ANDROID_REAL_DEVICE_EVIDENCE_URI="$(trim_value "${MOBILE_E2E_ANDROID_REAL_DEVICE_EVIDENCE_URI:-}")"
IOS_REAL_DEVICE_RUNNER="$(trim_value "${MOBILE_E2E_IOS_REAL_DEVICE_RUNNER:-}")"
ANDROID_REAL_DEVICE_RUNNER="$(trim_value "${MOBILE_E2E_ANDROID_REAL_DEVICE_RUNNER:-}")"
